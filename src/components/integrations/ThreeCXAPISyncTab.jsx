...
import {
  Phone, Plus, Trash2, RefreshCw, Building2, Clock, CheckCircle2,
  Search, XCircle, ChevronDown, Loader2, Globe, Pencil,
} from 'lucide-react';
        ...
        <div className="space-y-3">
          {mappings.length > 5 && (
            <div className="relative">
              ...
              <Input placeholder="Search customers..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="pl-9 h-9 text-sm" />
            </div>
          )}
        ...
        <DialogContent className="max-w-lg" style={{ zIndex: 9999 }}>
          ...
          <div className="space-y-4 pt-4">
            ...
            <div>
              ...
              <Input placeholder="https://mycompany.3cx.us:5001" value={instanceUrl} onChange={(e) => setInstanceUrl(e.target.value)} className="mt-1.5" />
            ...
            <div>
              ...
              <Input placeholder="Company 3CX" value={instanceName} onChange={(e) => setInstanceName(e.target.value)} className="mt-1.5" />
            </div>
