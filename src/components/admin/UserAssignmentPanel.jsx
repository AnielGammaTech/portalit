...
export default function UserAssignmentPanel() {
  ...
  const handleOrganizationChange = (user, customerId) => {
    ...
    updateUserMutation.mutate({
      ...
      customerName: customerId === 'none' ? null : customer?.name
    });
  };
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 ml-auto">
                      <Switch
                        ...
                        disabled={!isApproved}
                      />
                      <span className={`text-sm font-medium ${isApproved ? 'text-green-600' : 'text-slate-400'}`}>
      ...
      <Dialog open={inviteDialogOpen} onOpenChange={setInviteDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Send an invitation to join the portal. They will need to be assigned to an organization after signing up.
            </DialogDescription>
          </DialogHeader>
