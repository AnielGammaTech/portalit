    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-6">
          ...
          {/* Service Integrations - Only show if company has integrations configured */}
          {hasAnyIntegration && (
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {/* JumpCloud Status - Only show if company has JumpCloud */}
                {hasJumpCloud && (
                ...
                {/* Spanning Backup Status - Only show if company has Spanning */}
                {hasSpanning && (
